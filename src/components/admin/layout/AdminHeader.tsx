		...
		<header className="h-16 border-b border-white/5 bg-[#0c0c0f]/80 backdrop-blur-md flex items-center justify-between px-6 sticky top-0 z-20">
			...
			<div className="flex items-center gap-6">
				...
				<div className="flex items-center gap-3 pl-6 border-l border-white/10">
					<div className="w-8 h-8 rounded-full bg-gradient-to-tr from-aurora-violet to-aurora-violet flex items-center justify-center text-xs font-bold text-white">
