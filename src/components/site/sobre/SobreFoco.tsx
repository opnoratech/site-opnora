			...
			<div className="relative z-10 mx-auto max-w-[90rem] px-4 sm:px-6 lg:px-12">
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
					...
					<div className="flex flex-col items-start text-left lg:col-span-6">
						...
						>
							<p>
								Na fase atual, focamos em validar ideias com rapidez,
								desenvolver arquiteturas sólidas e resolver problemas reais de
								ponta a ponta.
							</p>
							<p>
								Nosso objetivo não é apenas entregar código, mas criar
								ecossistemas digitais inteligentes e escaláveis que geram valor
								contínuo.
							</p>
						</ScrollReveal>
					</div>
								...
								{tracks.map((track, index) => {
									...
									return (
										<ScrollReveal key={index} as="li" delay={150 + index * 50}>
											<div
												onClick={() =>
													setSelectedTrack(isSelected ? null : index)
												}
