...
const ADICIONAIS: AdicionalItem[] = [
	...
	},
	{
		...
		idealPara:
			"Empresas que querem suporte recorrente, atualizações e pequenas melhorias mensais.",
				...
				<div className="max-w-3xl mb-12">
					...
					<ScrollReveal delay={200}>
						<p className="text-sm sm:text-base text-slate-400 font-light leading-relaxed">
							Depois de lançar seu projeto, a Opnora continua ao lado da sua
							empresa com acompanhamento mensal de melhorias, tráfego,
							automações e análise de dados. Esses serviços podem ser
							contratados como complementos pós-entrega ou incorporados
					...
					<div className="mt-14 rounded-2xl bg-gradient-to-br from-white/[0.03] to-transparent border border-white/10 p-6 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
						...
						<div className="space-y-3 text-center md:text-left max-w-xl">
							...
							<p className="text-xs sm:text-sm text-slate-400 font-light leading-relaxed">
								A Opnora ajuda a identificar a melhor próxima etapa para manter
								seu projeto saudável, evoluindo e gerando resultado.
							</p>
						</div>
