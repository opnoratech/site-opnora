...
import { FaRobot, FaShareNodes, FaChartColumn, FaBrain, FaArrowRight } from "react-icons/fa6";
            ...
            {SOLUCOES.map((sol) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative rounded-sm bg-[#131318] border border-white/[0.05] p-6 sm:p-7 transition-all duration-700 ease-out hover:bg-[#181820] hover:border-[#b3a1ff]/20 hover:shadow-[0_8px_30px_rgba(179,161,255,0.08)] hover:-translate-y-2 overflow-hidden"
                >
                  {/* Conteúdo Principal (Horizontal & Limpo) */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center relative z-10">
                ...
                <div className="lg:col-span-7">
                  ...
                  <p className="text-xs sm:text-sm text-slate-400 leading-relaxed mb-5">
                    Campanhas precisam de uma boa estrutura para converter. Por isso, a Opnora
                    conecta anúncios com páginas, formulários, WhatsApp, métricas e automações para
                    transformar cliques em oportunidades acompanháveis.
                  </p>
                ...
                <div className="lg:col-span-5">
                  <div className="relative rounded-xl bg-[#0a0a0e]/90 border border-white/10 p-5 sm:p-6 shadow-2xl backdrop-blur-md overflow-hidden group">
                    ...
                    {/* Node 1: Anúncios */}
                    <div className="relative flex items-center justify-between bg-white/[0.03] border border-white/10 rounded-lg p-3.5 hover:border-aurora-violet/40 transition-colors">
                      <div>
                        <div className="text-xs font-bold text-white">Anúncios (Google & Meta)</div>
                        <div className="text-[11px] text-slate-400">Atração direcionada</div>
                      </div>
                    ...
                    <div className="relative flex items-center justify-between bg-white/[0.03] border border-white/10 rounded-lg p-3.5 hover:border-aurora-violet/40 transition-colors">
                      <div>
                        <div className="text-xs font-bold text-white">Landing Page & WhatsApp</div>
                        <div className="text-[11px] text-slate-400">Captura com alta conversão</div>
                      </div>
                      <span className="font-mono text-[10px] text-aurora-violet bg-aurora-violet/10 border border-aurora-violet/20 px-2 py-0.5 rounded">
                        LEADS TRACKEADOS
                      </span>
                    ...
                    <div className="relative flex items-center justify-between bg-white/[0.03] border border-white/10 rounded-lg p-3.5 hover:border-aurora-violet/40 transition-colors">
                      <div>
                        <div className="text-xs font-bold text-white">Métricas, CRM & ROAS</div>
                        <div className="text-[11px] text-slate-400">Decisão baseada em dados</div>
                      </div>
                      <span className="font-mono text-[10px] text-aurora-violet bg-aurora-violet/10 border border-aurora-violet/20 px-2 py-0.5 rounded">
                        RETORNO REAL
                      </span>
