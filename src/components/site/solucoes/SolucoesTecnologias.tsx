        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-between gap-4 mb-6">
            <div className="flex items-center gap-3">
              <span className="font-mono text-xs font-bold text-aurora-violet">{cap.num}</span>
...
export function SolucoesTecnologias({ bgClass = "bg-[#0e0e12]" }: SolucoesTecnologiasProps = {}) {
  return (
    <section
      className={`relative w-full ${bgClass} py-20 lg:py-28 border-t border-b border-white/5 overflow-hidden`}
    >
      {/* Background Subtle Gradient */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-gradient-to-tr from-aurora-violet/5 via-transparent to-aurora-cyan/5 blur-[60px] md:blur-[120px] pointer-events-none" />
