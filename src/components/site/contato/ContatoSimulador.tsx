  ...
  const renderResumoContent = () => {
    ...
    return (
      <div className="space-y-5 text-left text-xs">
        ...
        <div className="p-4 rounded-xl border border-aurora-violet/20 bg-aurora-violet/4 text-left space-y-2">
        ...
        <div className="space-y-2">
          ...
          {hasObjectives ? (
              ...
              {selectedObjectives.map((id) => {
                ...
                return (
                  <button
                    ...
                    className="cursor-pointer px-2.5 py-1 rounded-md bg-aurora-violet/6 border border-aurora-violet/30 text-slate-200 hover:bg-red-950/30 hover:border-red-500/40 hover:text-red-400 transition-all flex items-center gap-1.5 text-[11px]"
                  >
                    <span>{label}</span>
            ...
            <div className="px-3 py-2 rounded-lg border border-dashed border-white/5 bg-white/1 text-slate-500 italic text-[11px] font-light text-center">
        ...
        <div className="space-y-2">
          ...
          {hasFeatures ? (
            <div className="max-h-50 overflow-y-auto pr-1.5 flex flex-wrap gap-1.5 custom-scrollbar">
                ...
                return (
                  <button
                    ...
                    className={`cursor-pointer px-2.5 py-1 rounded border transition-all duration-300 flex items-center gap-1.5 text-[11px] leading-snug ${
                      isInc
                        ? "bg-aurora-violet/4 border-aurora-violet/20 text-purple-300/90 hover:bg-red-950/30 hover:border-red-500/40 hover:text-red-400 hover:shadow-none"
                        : "bg-amber-500/4 border-amber-500/20 text-amber-300/90 hover:bg-red-950/30 hover:border-red-500/40 hover:text-red-400 hover:shadow-none"
                    }`}
                  >
                    <span>
            ...
            <div className="flex flex-wrap gap-1.5">
              {removedFeatures.map((feat: string) => (
                <button
                  ...
                  className="cursor-pointer px-2 py-0.5 rounded border border-red-500/20 bg-red-500/3 text-slate-400 hover:bg-emerald-950/20 hover:border-emerald-500/30 hover:text-emerald-400 transition-all flex items-center gap-1 text-[11px] line-through decoration-red-500/40"
                >
                  <span>{feat}</span>
        ...
        <div className="border-t border-white/5 pt-4 space-y-2">
          ...
          {pricingEstimate.basePrice > 0 || pricingEstimate.extraMonthly > 0 ? (
            <div className="space-y-2">
              ...
              {removedFeatures.length > 0 && (
                <div className="text-[10px] text-amber-400/80 bg-amber-400/2 border border-amber-400/10 rounded-lg p-2 leading-normal">
  ...
  return (
    <>
      ...
      >
        ...
        <ScrollReveal delay={300} className="w-full">
          <div className="rounded-lg bg-[#121218] border border-white/10 p-6 sm:p-10 shadow-[0_15px_50px_rgba(0,0,0,0.6)] relative overflow-hidden">
            <div className="absolute -top-32 -right-32 w-80 h-80 bg-aurora-violet/5 blur-[50px] md:blur-[100px] rounded-full pointer-events-none" />
              ...
              <div className="space-y-8 relative z-10">
                ...
                <div className="text-center max-w-2xl mx-auto space-y-4">
                  ...
                  <p className="text-slate-400 text-xs sm:text-sm leading-relaxed max-w-md mx-auto">
                    Nossa equipe já está analisando as informações técnicas e preparará uma proposta
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6 border-t border-white/5 text-left">
                  ...
                  <div className="space-y-6 bg-white/1 border border-white/5 rounded-xl p-6">
                    <div>
                    ...
                    {selectedFeatures.length > 0 && (
                      <div className="space-y-2">
                        ...
                        <div className="max-h-35 overflow-y-auto pr-2 space-y-1.5 scrollbar-thin custom-scrollbar">
                          <style
                  ...
                  <div className="space-y-6 bg-white/1 border border-white/5 rounded-xl p-6">
                    ...
                    {formData.descricao && (
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-slate-300 leading-relaxed bg-black/35 rounded-lg p-3.5 border border-white/5 max-h-30 overflow-y-auto whitespace-pre-wrap">
                          {formData.descricao}
                        </p>
                      </div>
                    )}
                ...
                {currentStep === 1 && (
                  <div className="space-y-6">
                        ...
                        {[
                          ...
                          return (
                            <button
                              ...
                              className={`flex flex-col items-center justify-center p-3 rounded-xl border transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-aurora-violet/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#050507] ${
                                active
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 mt-1">Selecione um ou mais objetivos.</p>
                    </div>
                        ...
                        return (
                          <div key={opt.id} className="relative">
                            <button
                              ...
                              className={`cursor-pointer flex items-center justify-start w-full h-14 sm:h-17 rounded-xl border px-5 py-2 transition-all duration-300 text-left text-xs sm:text-sm font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-aurora-violet/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#050507] ${
                                active
                                  ? "bg-aurora-violet/[0.07] border-aurora-violet shadow-[0_0_15px_rgba(162,128,255,0.1)] text-white"
                                  : "bg-white/2 border-white/10 hover:border-white/20 hover:bg-white/4 text-slate-400 hover:text-white"
                              }`}
                            >
                      ...
                      {SOLUTION_OPTIONS.map((sol) => {
                        ...
                        return (
                          <button
                            ...
                            aria-pressed={active}
                            onClick={() => toggleSolution(sol)}
                            className={`cursor-pointer flex items-center justify-center w-full h-14 sm:h-17 rounded-xl border px-5 py-2 transition-all duration-300 text-center text-xs sm:text-sm font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-aurora-violet/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#050507] ${
                              active
                                ? "bg-aurora-violet/[0.07] border-aurora-violet shadow-[0_0_15px_rgba(162,128,255,0.1)] text-white"
                                : "bg-white/2 border-white/10 hover:border-white/20 hover:bg-white/4 text-slate-400 hover:text-white"
                            }`}
                    ...
                    <div className="space-y-3">
                      {FEATURE_CATEGORIES.map((cat) => {
                        ...
                        return (
                          <div
                            key={cat.name}
                            className="rounded-xl bg-white/1 border border-white/5 overflow-hidden transition-all duration-300"
                          >
                            <button
                              type="button"
                              onClick={() => toggleCategory(cat.name)}
                              className="cursor-pointer w-full flex items-center justify-between px-5 py-4 bg-white/2 hover:bg-white/4 transition-all"
                            >
                                ...
                                {cat.items.map((item) => {
                                  ...
                                  if ((isPages || isIntegrations || isSupport) && active) {
                                    ...
                                    return (
                                      <div
                                        key={item}
                                        className={`flex flex-col items-center justify-center w-full min-h-14 rounded-lg border px-4 py-2 transition-all duration-300 text-center text-xs font-medium gap-1.5 ${
                                          isIncludedCount
                                  ...
                                  if (canCycle && active) {
                                    return (
                                      <div
                                        key={item}
                                        className={`flex flex-col items-center justify-center w-full min-h-16 rounded-lg border px-3 py-2 transition-all duration-300 text-center text-xs font-medium gap-2 ${
                                          isIncluded
                                            ? "bg-aurora-violet/[0.07] border-aurora-violet shadow-[0_0_12px_rgba(162,128,255,0.1)] text-white"
                                            : "bg-amber-500/[0.07] border-amber-400/60 shadow-[0_0_12px_rgba(245,158,11,0.1)] text-white"
                                        }`}
                                  ...
                                  return (
                                    <button
                                      ...
                                      aria-pressed={active}
                                      onClick={() => toggleFeature(item)}
                                      className={`cursor-pointer flex flex-col items-center justify-center w-full min-h-14 rounded-lg border px-4 py-2 transition-all duration-300 text-center text-xs font-medium gap-1 ${
                                        active && isIncluded
                                          ? "bg-aurora-violet/[0.07] border-aurora-violet shadow-[0_0_12px_rgba(162,128,255,0.1)] text-white"
                                          : active && !isIncluded
                                            ? "bg-amber-500/[0.07] border-amber-400/60 shadow-[0_0_12px_rgba(245,158,11,0.1)] text-white"
                                            : isRemovedFromBase
                                              ? "bg-red-500/1 border-red-500/10 hover:border-red-500/25 text-slate-500 hover:text-slate-400"
                                              : "bg-white/2 border-white/10 hover:border-white/20 hover:bg-white/4 text-slate-400 hover:text-white"
                                      }`}
                                    >
                                      <span
                ...
                {currentStep === 4 && (
                  <div className="space-y-6">
                      ...
                      const planLabel = isLanding
                        ...
                        : isEssencial
                          ...
                          : isProfissional
                            ...
                            : "Escopo Sob Medida";
                      return (
                        <div className="bg-aurora-violet/4 border border-aurora-violet/15 rounded-xl p-5 flex flex-col md:flex-row md:items-center justify-between gap-4 animate-fade-in mb-4">
                          <div className="space-y-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 mt-1">
                        Esses dados servem para nossa equipe analisar o escopo técnico e preparar um
                        escopo customizado.
                      </p>
                    </div>
                                  ...
                                  return (
                                    <button
                                      ...
                                      className={`cursor-pointer w-full text-left px-4 py-2.5 text-sm transition-colors ${
                                        selected
                                          ? "text-aurora-violet bg-aurora-violet/4 font-medium"
                                ...
                                {INVESTMENT_OPTIONS.map((opt) => {
                                  ...
                                  return (
                                    <button
                                      ...
                                      className={`cursor-pointer w-full text-left px-4 py-2.5 text-sm transition-colors touch-manipulation active:bg-white/8 ${
                                        selected
                                          ? "text-aurora-violet bg-aurora-violet/4 font-medium"
                                          : "text-slate-300 md:hover:text-white md:hover:bg-white/4"
                                      }`}
                                    >
                                      {opt}
                                    </button>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full bg-[#0c0c10] border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-aurora-violet focus:shadow-[0_0_15px_rgba(162,128,255,0.1)] transition-all duration-300 min-h-30 resize-y"
                      />
                    </div>
                  </div>
                )}
      ...
      <ScrollReveal delay={300}>
        <div className="mt-14 rounded-2xl bg-linear-to-br from-white/3 to-transparent border border-white/10 p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2 text-center md:text-left max-w-xl">
            <h3 className="text-lg font-display font-bold text-white">
              Ainda não sabe exatamente do que precisa?
            </h3>
            <p className="text-xs text-slate-400 font-light leading-relaxed">
              Explique brevemente o problema por WhatsApp ou solicite um diagnóstico. A Opnora ajuda
              a identificar o melhor ponto de partida por meio de uma conversa preliminar.
            </p>
          </div>
