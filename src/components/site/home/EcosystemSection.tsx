...
function CardItem({
	...
	return (
		<ScrollReveal
			delay={delay}
			className={`h-full ${card.span ? "md:col-span-2" : ""}`}
		>
			<div
				...
				style={{
					borderColor: isMobileActive
						? card.borderGlow.replace("0.65", "0.3")
						: undefined,
		...
		>
			<div className="relative z-10 mx-auto max-w-[90rem] px-4 sm:px-6 lg:px-12">
				<div className="flex flex-col items-start text-left mb-16 lg:mb-20">
					...
					>
						A Opnora atua em três frentes conectadas para criar sistemas mais
						úteis, organizados e preparados para acompanhar a evolução de cada
						projeto.
					</ScrollReveal>
				</div>
