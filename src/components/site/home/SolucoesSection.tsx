              ...
              {pathD.main && (
                <>
                  ...
                  <path
                    ...
                    strokeWidth="8"
                    strokeLinecap="round"
                    style={{ filter: "blur(6px)", opacity: 0.45, mixBlendMode: "screen" }}
                  />
                  <path
                    d={pathD.ribbon2}
                    fill="none"
                  ...
                  <path
                    ...
                    strokeWidth="12"
                    strokeLinecap="round"
                    style={{ filter: "blur(8px)", opacity: 0.4, mixBlendMode: "screen" }}
                  />
                  <path
                    d={pathD.ribbon1}
                    fill="none"
                  ...
                  <path
                    ...
                    strokeWidth="5"
                    strokeLinecap="round"
                    style={{ filter: "blur(3px)", opacity: 0.5, mixBlendMode: "screen" }}
                  />
                  ...
                  <path
                    ...
                    strokeWidth="4"
                    strokeLinecap="round"
                    style={{ filter: "blur(2px)", opacity: 1, mixBlendMode: "screen" }}
                  />
                  <path
                    d={pathD.main}
                    fill="none"
                    ...
                    strokeWidth="1.2"
                    strokeLinecap="round"
                    style={{ filter: "drop-shadow(0 0 5px rgba(255,255,255,0.9))", opacity: 0.85 }}
                  />
                </>
              )}
            </svg>
