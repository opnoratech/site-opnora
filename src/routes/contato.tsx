            ...
            <div className="max-w-4xl text-left">
              ...
              <ScrollReveal delay={200}>
                <p className="mt-3 max-w-4xl text-sm sm:text-lg text-slate-400 font-light leading-relaxed">
                  Está pronto para estruturar a presença digital do seu negócio? Conte-nos sobre o
                  seu projeto, suas ideias e objetivos. Lemos cada mensagem com cuidado e
                  respondemos pessoalmente em até 24 horas úteis.
                </p>
              </ScrollReveal>
            </div>
          </div>
            ...
            <div className="space-y-8 lg:pr-4">
              ...
              <ScrollReveal delay={100}>
                <div className="space-y-3 pt-3">
                  ...
                  {/* Item LinkedIn */}
                  <a
                    href="https://linkedin.com/company/opnora"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3.5 group py-2.5 px-3.5 rounded-lg bg-[#121218]/50 border border-white/5 hover:border-white/15 hover:bg-[#121218] transition-all duration-300"
                  >
