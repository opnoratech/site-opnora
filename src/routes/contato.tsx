...
function ContatoPage() {
	...
	async function onSubmit(e: React.FormEvent) {
		...
		try {
			...
			console.error(err);
			toast.error(
				"Erro ao enviar mensagem. Tente novamente ou fale no WhatsApp.",
			);
		} finally {
			setSubmitting(false);
		}
	...
	return (
		<div className="bg-[#08080b] min-h-screen text-white">
							...
							<ScrollReveal>
								<div>
									...
									<p className="text-sm sm:text-base text-slate-400 font-light leading-relaxed">
										A Opnora é construída em torno de trabalho significativo e
										colaboração próxima. Se você tem uma ideia para debater, um
										projeto para desenvolver ou deseja tirar dúvidas sobre
										nossas soluções, envie sua mensagem. Analisamos cada
							...
							>
								<div className="grid gap-6 sm:grid-cols-2">
									...
									<div>
										...
										{errors.nome && (
											<p className="text-[11px] text-red-400 mt-1 font-light">
												{errors.nome}
											</p>
										)}
									</div>
			...
			>
				<ContatoSimulador
					defaultPlano={planoKey || expansaoKey}
					defaultNivel={nivelKey}
				/>
			</Suspense>
					...
					<ScrollReveal>
						<div className="text-center max-w-3xl mx-auto mb-16">
							...
							<p className="text-slate-400 text-sm sm:text-base font-light">
								Prefere simular antes de enviar, entender os valores ou ir
							...
							<div className="group relative w-full h-full flex flex-col justify-start rounded-lg bg-[#121218] border border-white/10 p-6 sm:p-7 hover:-translate-y-1 hover:bg-[#181820] hover:border-white/15 hover:shadow-[0_10px_30px_rgba(0,0,0,0.5)] transition-all duration-300 ease-out">
								<div className="space-y-4">
									...
									<p className="text-xs sm:text-sm text-slate-400 leading-relaxed font-light">
										Quer ter uma estimativa de investimento sob medida agora?
										Responda a algumas perguntas rápidas no nosso simulador de
										projetos.
									</p>
								</div>
								<div className="mt-4">
						...
						<ScrollReveal delay={200} className="flex">
							<div className="group relative w-full h-full flex flex-col justify-start rounded-lg bg-[#121218] border border-white/10 p-6 sm:p-7 hover:-translate-y-1 hover:bg-[#181820] hover:border-white/15 hover:shadow-[0_10px_30px_rgba(0,0,0,0.5)] transition-all duration-300 ease-out">
								<div className="space-y-4">
									...
									<p className="text-xs sm:text-sm text-slate-400 leading-relaxed font-light">
										Veja os planos prontos da Opnora e descubra o que cada
										escopo inclui, valores ideais de partida e as principais
						...
						<ScrollReveal delay={300} className="flex">
							<div className="group relative w-full h-full flex flex-col justify-start rounded-lg bg-[#121218] border border-white/10 p-6 sm:p-7 hover:-translate-y-1 hover:bg-[#181820] hover:border-white/15 hover:shadow-[0_10px_30px_rgba(0,0,0,0.5)] transition-all duration-300 ease-out">
								<div className="space-y-4">
									...
									<p className="text-xs sm:text-sm text-slate-400 leading-relaxed font-light">
										Sem fila, sem formulários. Prefere falar diretamente com
										nosso especialista por WhatsApp para tirar suas dúvidas de
										forma rápida?
									</p>
								</div>
								<div className="mt-4">
						...
						<div className="space-y-4 max-w-2xl">
							<ScrollReveal>
								...
								<p className="text-slate-400 text-sm sm:text-base font-light leading-relaxed">
									Prezamos por uma comunicação transparente e direta desde o
									primeiro segundo. Aqui está o passo a passo de como
									trabalhamos.
								</p>
							</ScrollReveal>
						</div>
									...
									<li className="flex items-start gap-3.5">
										...
										<div>
											...
											<p className="text-xs sm:text-sm text-slate-400 font-light leading-relaxed">
												Avaliamos sua mensagem para entender as necessidades
												técnicas do seu negócio.
											</p>
										</div>
									</li>
									<li className="flex items-start gap-3.5">
										...
										<div>
											...
											<p className="text-xs sm:text-sm text-slate-400 font-light leading-relaxed">
												Retornamos em até 24 horas úteis via WhatsApp ou E-mail
												para alinhar os detalhes.
											</p>
										</div>
									</li>
									<li className="flex items-start gap-3.5">
										...
										<div>
											...
											<p className="text-xs sm:text-sm text-slate-400 font-light leading-relaxed">
												Alinhamos o que você precisa para otimizar o
												investimento sem desperdícios.
											</p>
										</div>
									</li>
									<li className="flex items-start gap-3.5">
										...
										<div>
											...
											<p className="text-xs sm:text-sm text-slate-400 font-light leading-relaxed">
												Enviamos a proposta com escopo detalhado, valores fixos
												e prazos definidos.
											</p>
										</div>
									</li>
				...
				<div className="mx-auto max-w-[85rem] px-4 sm:px-6 lg:px-12 relative z-10">
					<ScrollReveal>
						<div className="text-center max-w-3xl mx-auto mb-16">
							...
							<p className="text-slate-400 text-sm sm:text-base font-light">
								Tire suas dúvidas rápidas sobre como criamos sites, sistemas e
								automações na Opnora.
							</p>
						</div>
					</ScrollReveal>
