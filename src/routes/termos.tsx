					...
					<div className="space-y-12 text-slate-400 font-light leading-relaxed text-[14px] sm:text-[15px]">
						...
						<div className="pb-8 border-b border-white/5">
							...
							<p className="text-slate-300">
								Ao navegar no site da Opnora Technologies ("Site") ou utilizar
								nossos formulários de simulação e contato, você concorda em
								cumprir estes Termos de Uso. Caso não concorde com estes termos,
								solicitamos que interrompa a navegação no site.
							</p>
						</div>
						...
						<div className="pb-8 border-b border-white/5">
							...
							<p className="mb-4 text-slate-300">
								Você concorda em utilizar o site apenas para finalidades
								legítimas de informação e contratação de serviços. É
								expressamente proibido:
							</p>
							<ul className="list-disc pl-5 space-y-2 mt-4 marker:text-white">
								<li>
									Tentar acessar áreas restritas, servidores ou códigos da
									plataforma sem autorização.
								</li>
								<li>
									Utilizar mecanismos automatizados (bots, scrapers) para
									extrair dados do site.
								</li>
								<li>
									Enviar mensagens maliciosas, spam ou tentativas de invasão
						...
						<div className="pb-8 border-b border-white/5">
							...
							<p className="text-slate-300">
								Todo o conteúdo deste site — incluindo logotipos, marcas,
								códigos, identidades visuais, textos e estruturas de dados —
								pertence exclusivamente à Opnora Technologies. É proibida a
								cópia, reprodução ou engenharia reversa sem autorização prévia
								por escrito.
							</p>
						</div>
						...
						<div className="pb-8 border-b border-white/5">
							...
							<p className="text-slate-300">
								As estimativas de valores e prazos geradas no simulador do site
								têm caráter puramente informativo e preliminar. A contratação
								definitiva de desenvolvimento de software é formalizada através
						...
						<div className="pb-8 border-b border-white/5">
							...
							<p className="text-slate-300">
								Embora nos esforcemos para manter o site continuamente
								disponível e seguro, a Opnora não se responsabiliza por
								instabilidades temporárias decorrentes de falhas em redes de
								terceiros, provedores de conexão ou manutenção de
								infraestrutura.
							</p>
						</div>
						...
						<div className="pb-8 border-b border-white/5">
							...
							<p className="text-slate-300">
								Nosso site pode conter links para serviços ou plataformas
								externas. A Opnora não exerce controle sobre o conteúdo ou
						...
						<div className="pb-8 border-b border-white/5">
							...
							<p className="text-slate-300">
								...
								Brasil (incluindo a LGPD e o Marco Civil da Internet). Eventuais
