					...
					<div className="bg-[#131318] border border-white/5 rounded-2xl p-6 sm:p-8">
						...
						{activeTab === "seo" && (
							<div className="space-y-6">
								...
								<div>
									<label className="block text-xs font-mono text-slate-400 mb-2 uppercase">Título da Página (Meta Title)</label>
									<input
										type="text"
									...
									/>
									<p className="text-xs text-slate-500 mt-2">Aparece na aba do navegador e no título das buscas do Google.</p>
								</div>

								<div>
									<label className="block text-xs font-mono text-slate-400 mb-2 uppercase">Descrição (Meta Description)</label>
									<textarea
										rows={3}
									...
									/>
									<p className="text-xs text-slate-500 mt-2">Resumo exibido nos resultados de busca. Mantenha entre 150-160 caracteres.</p>
								</div>
							</div>
						)}
						...
						{activeTab === "social" && (
							<div className="space-y-6">
								...
								<div>
									<label className="block text-xs font-mono text-slate-400 mb-2 uppercase">WhatsApp</label>
									<input
										type="text"
									...
									/>
									<p className="text-xs text-slate-500 mt-2">Apenas números (DDI + DDD + Número). Ex: 5585...</p>
								</div>

								<div>
									<label className="block text-xs font-mono text-slate-400 mb-2 uppercase">E-mail Público</label>
									<input
										type="email"
								...
								<div>
									<label className="block text-xs font-mono text-slate-400 mb-2 uppercase">Link do Instagram</label>
									<input
										type="url"
								...
								<div>
									<label className="block text-xs font-mono text-slate-400 mb-2 uppercase">Link do LinkedIn</label>
									<input
										type="url"
						...
						{activeTab === "scripts" && (
							<div className="space-y-6">
								...
								<div>
									<label className="block text-xs font-mono text-slate-400 mb-2 uppercase">Google Analytics ID</label>
									<input
										type="text"
									...
									/>
									<p className="text-xs text-slate-500 mt-2">Deixe em branco para desativar o rastreamento.</p>
								</div>
							</div>
						)}
								...
								<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
									<div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex items-center gap-4">
										...
										<div>
											...
											<p className="text-xs text-emerald-500/70">Conectado e respondendo (Supabase)</p>
										</div>
									</div>
