...
export const Route = createFileRoute("/privacidade")({
  head: () => ({
    ...
    links: [{ rel: "preload", as: "image", href: "/images/privacidade_aurora_hero.webp" }],
  }),
...
function PrivacidadePage() {
  return (
    <main className="flex-1 bg-[#0e0e12]">
      {/* Header Section */}
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 min-h-[50vh] md:min-h-[55vh] flex flex-col justify-center overflow-hidden bg-[#0e0e12]">
        <HeroMedia
          src="/images/privacidade_aurora_hero.webp"
          width={1920}
          height={1080}
          isPriority={true}
          alt="Privacidade"
          ...
          <div className="space-y-12 text-slate-400 font-light leading-relaxed text-[14px] sm:text-[15px]">
            ...
            <div className="pb-8 border-b border-white/5">
              ...
              <ul className="list-disc pl-5 space-y-2 mt-4 marker:text-white">
                <li>
                  <strong className="text-white font-medium">Formulários de contato:</strong> Nome,
            ...
            <div className="pb-8 border-b border-white/5">
              ...
              <ul className="list-disc pl-5 space-y-2 mt-4 marker:text-white">
                ...
                <li>Tipo de navegador, sistema operacional e tipo de dispositivo.</li>
            ...
            <div className="pb-8 border-b border-white/5">
              ...
              <p className="mb-4 text-slate-300">As informações coletadas são utilizadas para:</p>
              <ul className="list-disc pl-5 space-y-2 marker:text-white">
                <li>Responder às suas solicitações de contato e tirar dúvidas.</li>
                <li>Elaborar propostas comerciais e orçamentos para o seu projeto de software.</li>
                <li>Garantir a segurança, integridade e estabilidade do site.</li>
              </ul>
            </div>
