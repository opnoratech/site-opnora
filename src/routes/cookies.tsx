					...
					<div className="space-y-12 text-slate-400 font-light leading-relaxed text-[14px] sm:text-[15px]">
						...
						<div className="pb-8 border-b border-white/5">
							...
							<p className="text-slate-300">
								...
								dispositivo ao navegar em um site. Eles permitem reconhecer as
								escolhas do usuário e manter o funcionamento correto da
								navegação e dos formulários.
							</p>
						</div>
						...
						<div className="pb-8 border-b border-white/5">
							...
							<p className="mb-4 text-slate-300">
								Na Opnora Technologies, prezamos por uma abordagem de
								privacidade estrita. Utilizamos cookies de forma mínima e focada
								exclusivamente em:
							</p>
							<ul className="list-disc pl-5 space-y-2.5 mt-4 marker:text-white">
								...
								<li>
									...
									para entender o desempenho das páginas sem rastrear sua
									identidade pessoal.
								</li>
							</ul>
						</div>
						...
						<div className="pb-8 border-b border-white/5 space-y-8">
							...
							<div className="space-y-4">
								...
								<p className="text-sm text-slate-400">
									Estes cookies são fundamentais para o funcionamento do site e
									proteção contra envios maliciosos.
								</p>
								<div className="overflow-x-auto rounded-xl border border-white/10 bg-[#131318]/70 backdrop-blur-sm">
									<table className="w-full text-left text-xs sm:text-sm">
										...
										<tbody className="divide-y divide-white/5 text-slate-300">
											<tr>
												<td className="py-3 px-4 font-mono text-[#a280ff]">
													opnora_session
												</td>
											...
											<tr>
												...
												<td className="py-3 px-4">
													Protege formulários contra envios não autorizados
													(CSRF).
												</td>
												<td className="py-3 px-4">Sessão</td>
												<td className="py-3 px-4">Próprio</td>
						...
						<div className="pb-8 border-b border-white/5">
							...
							<p className="text-slate-300">
								A Opnora não utiliza cookies de redes de anúncios, remarketing,
								corretores de dados ou rastreadores de publicidade de terceiros.
							</p>
						</div>
						...
						<div className="pb-8 border-b border-white/5">
							...
							<p className="text-slate-300 mb-6">
								Você pode desativar ou excluir cookies através das configurações
								do seu navegador:
							</p>
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm font-mono">
								<div className="p-4 rounded-xl bg-[#131318] border border-white/5 space-y-1">
									<span className="text-[#a280ff] font-bold">
										Google Chrome
									</span>
						...
						<div>
							...
							<p className="text-slate-300">
								Se tiver dúvidas sobre nossa utilização de cookies, entre em
